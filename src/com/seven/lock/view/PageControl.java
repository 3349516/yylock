...
public class PageControl extends LinearLayout
{
	...
	private void initPageControl()
	{
		...
		((ShapeDrawable) activeDrawable).getPaint().setColor(mContext.getResources().getColor(R.color.point));
		((ShapeDrawable) inactiveDrawable).getPaint().setColor(Color.WHITE);
