...
import com.seven.lock.LockMain;
...
import com.seven.lock.view.LockPatternView;
import com.umeng.analytics.MobclickAgent;

public class PatternMain extends BaseActivity {
    ...
    protected LockPatternView.OnPatternListener mChooseNewLockPatternListener = new LockPatternView.OnPatternListener() {
            ...
            public void onPatternDetected(List<LockPatternView.Cell> pattern) {
                    ...
                    if (pattern.size() < LockPatternUtils.MIN_LOCK_PATTERN_SIZE) {
                        ...
                        String hash  = LockPatternUtils.patternToHash(mChosenPattern);
                        String value =  MD5.getInstance().createMD5(hash);
                        String psw = helper.getValue(LockPatternUtils.PatternPwd);
                        if(psw.equals(value)){
                           if(tag == 0){			//´ò¿ª³ÌÐò
                        	   Intent intent = new Intent(PatternMain.this,
										LockMain.class);
								startActivity(intent);
								
                           }/*else if(tag == 3){ 		//À¹½Ø½çÃæ
                        	   PatternMain.this.finish();
                           }*/
                           PatternMain.this.finish();
                           
                           MobclickAgent.onEvent(PatternMain.this, "LockPattern_unlock") ;
                        }else{
    ...
    protected void setupViews() {
        setContentView(R.layout.choose_lock_main);
